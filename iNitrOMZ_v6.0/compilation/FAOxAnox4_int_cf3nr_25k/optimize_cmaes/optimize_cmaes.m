% Here, specify iNitrOMZ root path ($PATHTOINSTALL/iNitrOMZ/)
 bgc1d_root='/u/scratch/d/danieleb/NitrOMZ/iNitrOMZ_v6.0/';
%addpath(genpath(bgc1d_root)); % adds root to MATLAB's search paths
% Adds CMAES subroutine:
%addpath('/u/scratch/d/danieleb/NitrOMZ/optimization/CMA_ES/');
%addpath('/u/home/d/danieleb/project1/matlabpathfiles/'); 

% Handles output directory
 OptName = 'FAOxAnox4_int_cf3nr_25k';
 OptNameLong = 'Fix All oxic, Vary Anoxic parameters, interpolated data, cost function #3 w/t no rates (&no second square), 25k evaluations max';
%OptName = 'Anox_Interp';
%OptName = 'Oxic_cmaes';
 curdir = pwd;
