function [tcost cost_pre] = bgc1d_fc2minimize_evaluate_cost(bgc,iplot)
...
%Data.weights =  	[1    1     0     1     2     0     1     0    0];	% Anoxic Optimization-1
 Data.weights =  	[1    0     0     0.5   3     0     2.5   0    1];	% Anoxic Optimization-1
 %			'nh4ton2o' 'noxton2o' 'no3tono2' 'anammox'
%Data.rates.weights = 	[1          1          1          1];
%Data.rates.weights = 	[0          0          0          0];
 Data.rates.weights = 	[0.3        0.3        0.3        0.3];
