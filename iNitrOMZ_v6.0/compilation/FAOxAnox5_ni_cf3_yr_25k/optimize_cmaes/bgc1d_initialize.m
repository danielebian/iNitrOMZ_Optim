...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 bgc.region = 'ETSP';
 bgc.root = '/u/scratch/d/danieleb/NitrOMZ/iNitrOMZ_v6.0/';
 ...
 %%%%% Time step / history %%%%%%
 bgc.nt = 50000/1.0;% Simulation length in timesteps
 bgc.dt = 100000*1.0; % timestep in seconds bgc.hist =  500; 
 ...
 %%%%%%%%% BGC params %%%%%%%%%%%
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 % Initialize dependent parameters? Turn off for genetic optimization
 bgc.depparams = 1;
